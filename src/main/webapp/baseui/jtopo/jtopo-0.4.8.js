...
function(a) {
    ...
    function c(c) {
        ...
        //导出canvas当前视野为图片
        this.saveCurrentImageInfo = function() {
...
//DisplayElement ,InteractiveElement, EditableElement
function(JTopo) {
...
function(JTopo) {
        ...
        this.setImage = function(b, c) {
            ...
            if ("string" == typeof b) {
                ...
                null == e ? (e = new Image, e.src = b, e.onload = function() {
                    ...
                    var f = JTopo.util.genImageAlarm(e);
                    f && (e.alarm = f),
                    d.image = e
    ...
    function k(a, b){
    	...
    	this.paint = function(a){
            ...
            if (this.image) {
                var b = a.globalAlpha;
                a.globalAlpha = this.alpha,
                null != this.image.alarm && null != this.alarm ? a.drawImage(this.image.alarm, -this.width / 2, -this.height / 2, this.width, this.height) : a.drawImage(this.image, -this.width / 2 + 5, -this.height / 2 + 5, 16, 16),
                a.globalAlpha = b
            } 
    	}
    	
    }
    Node.prototype = new JTopo.EditableElement,
    BaseNode.prototype = new Node,
    d.prototype = new BaseNode,
    e.prototype = new d,
    f.prototype = new BaseNode,
    ...
    g.prototype = new BaseNode,
    h.prototype = new BaseNode,
    i.prototype = new BaseNode,
    k.prototype = new BaseNode,
    JTopo.Node = BaseNode,
    JTopo.TextNode = d,
    JTopo.LinkNode = e,
    JTopo.CircleNode = f,
...
function(JTopo) {
    ...
    function HeaderFoldLink(a, b, c) {
        ...
        this.getStartPosition = function() {
            var a = {
                x: this.nodeA.x+5,
                y: this.nodeA.y + this.nodeA.height
            };
            //return "horizontal" == this.direction ? this.nodeZ.cx > a.x ? a.x += this.nodeA.width / 2 : a.x -= this.nodeA.width / 2 : this.nodeZ.cy > a.y ? a.y += this.nodeA.height / 2 : a.y -= this.nodeA.height / 2,
            return a
        },
