...
(function ($) {
    ...
    function UpdateLabel(group) {
        ...
        $("#" + group.counter).html(language.text('ui.show') + '<em>' + showingCount + '</em>'+language.text('ui.page.item')+ language.text('ui.total')+'<em>' + (showingCount + hiddenCount) + '</em>' + language.text('ui.page.item'));
    }
