...
(function () {
     ...
     */
    var URL = "/js/plugins/ueditor/" || (function(){
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"jsp/imageUp.jsp?ueditorType=img"             //图片上传提交地址
        ...
        ,snapscreenServerUrl: URL +"jsp/imageUp.jsp?ueditorType=img" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/jsp/snapImgUp.jsp"”
        ,snapscreenPath: URL + "jsp/"
        ,snapscreenServerPort: location.port                                   //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:URL + "jsp/imageUp.jsp?ueditorType=img"             //word转存提交地址
