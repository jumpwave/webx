...
<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="<%=basePath%>web/dataCollect/modules/task/css/index.css"/>
		<script>
			Namespace('Hik.dataCollect.task');
			Hik.dataCollect.task.taskName = '<%=taskName%>';
		</script>
		<script type="text/javascript" src="<%=basePath%>web/dataCollect/modules/task/js/index.js"></script>
		<script type="text/javascript" src="<%=basePath%>web/dataCollect/modules/task/js/logging.js"></script>
	...
	<body>
				...
				<tr>
					<td class="navigatorTd">
						...
						<div id="myflow_tools">
							...
							<div class="nav">
								<div class="divTitle">
									<div class="message">通用</div>
									<div class="line"></div>
									<div class="option">
										<div class="node state" id="state" type="SPECIAL">START</div>
									</div>
									<div class="option">
										<div class="node state" id="state" type="TRANS">转换</div>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- 开始 弹出窗 -->
		<div class="startDailog"></div>
		
		<!-- 转换 弹出窗口 -->
		<div class="transformDailog"></div>
	</body>
</html>